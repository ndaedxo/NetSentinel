      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="card-dark p-8 space-y-8 shadow-2xl">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 p-4 bg-slate-900/50 rounded-lg border border-slate-700/50">
                ...
                <input
                  ...
                  className="flex-1 bg-transparent text-slate-300 placeholder-slate-500 focus:outline-none text-base min-h-[44px]"
                  required
          ...
          <button
            ...
            disabled={isPending}
            className="w-full bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 border border-slate-600 hover:border-slate-500 disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px]"
          >
            Continue with Google OAuth
          </button>

          <div className="flex flex-col sm:flex-row sm:items-start space-y-3 sm:space-y-0 sm:space-x-3 p-4 bg-amber-500/10 border border-amber-500/30 rounded-lg">
            <AlertTriangle className="w-5 h-5 text-amber-400 flex-shrink-0 sm:mt-0.5" />
