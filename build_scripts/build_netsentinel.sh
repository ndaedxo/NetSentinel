#!/bin/bash -e
# Build NetSentinel package from git repo and create virtualenv where it can be run.
# Tested on macOS but should work elsewhere as long as the compile flags are configured.
#
# Environment variable options:
#    NETSENTINEL_BUILD_FULL_CLEAN=True - do a new git checkout
#    NETSENTINEL_BUILD_FRESH_VENV=True - recreate the venv

# Configurable variables
NETSENTINEL_GIT_REPO="https://github.com/netsentinel/netsentinel.git"
