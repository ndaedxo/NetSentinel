from . import CanaryService, create_canary_protocol
...
class MSSQLProtocol(create_canary_protocol(Protocol), TimeoutMixin):
    ...
    NMAP_PROBE_1 = TDSPacket(
        ...
        window=0,
        payload=(
            b"\x00\x00\x15\x00\x06\x01\x00\x1b\x00\x01\x02\x00\x1c\x00\x0c\x03\x00"
    ...
    def parsePreLogin(data):
        ...
        try:
            ...
            logger.error(f"Error parsing pre-login options: {e}")
    ...
    def consume_packet(self):
        ...
        try:
            ...
            logger.error(f"Error parsing TDS packet: {e}")
    ...
    def buildChallengeToken():
        spnegoheader = (
            b"\xa1\x82\x01Y0\x82\x01U\xa0\x03\n\x01\x01\xa1\x0c\x06\n"
        ...
        # template = c.get_data()
        old = (
            b"NTLMSSP\x00\x02\x00\x00\x00\x1e\x00\x1e\x008\x00\x00\x00"
            b"\x15\xc2\x8a\xe26Ph\x8a\xae\x84R\xbe@\xd5qt\xe4\x00\x00"
            b"\x00\xe4\x00\xe4\x00V\x00\x00\x00\x06\x02\xf0#\x00\x00\x00"
            b"\x0fW\x00I\x00N\x002\x00K\x001\x002\x00-\x00D\x00O\x00M\x00"
            b"A\x00I\x00N\x00S\x00\x02\x00\x1e\x00W\x00I\x00N\x002\x00K"
            b"\x001\x002\x00-\x00D\x00O\x00M\x00A\x00I\x00N\x00S\x00\x01"
            b"\x00\x1e\x00W\x00I\x00N\x002\x00K\x001\x002\x00-\x00D\x00O"
            b"\x00M\x00A\x00I\x00N\x00S\x00\x04\x00D\x00w\x00i\x00n\x002"
            b"\x00k\x001\x002\x00-\x00d\x00o\x00m\x00a\x00i\x00n\x00s\x00"
            b"r\x00v\x00.\x00c\x00o\x00r\x00p\x00.\x00t\x00h\x00i\x00n"
            b"\x00k\x00s\x00t\x00.\x00c\x00o\x00m\x00\x03\x00D\x00w\x00i"
            b"\x00n\x002\x00k\x001\x002\x00-\x00d\x00o\x00m\x00a\x00i\x00n"
            b"\x00s\x00r\x00v\x00.\x00c\x00o\x00r\x00p\x00.\x00t\x00h\x00"
            b"i\x00n\x00k\x00s\x00t\x00.\x00c\x00o\x00m\x00\x07\x00\x08"
            b"\x00\xa2\x9e\xda\x91\x1f\xbb\xd0\x01\x00\x00\x00\x00\x06"
            b"\x02\xf0#\x00\x00\x00\x0fy\x00o\x00y\x00o\x00m\x00a\x00"
            b"\x00\x00\x00\x00"
        )
