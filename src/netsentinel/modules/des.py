...
Example
-------
# Import specific functions from pyDes to avoid namespace pollution
try:
    from pyDes import des, triple_des, ECB, CBC, PAD_NORMAL, PAD_PKCS5
except ImportError:
    # Fallback for when pyDes is not available
    des = None
    triple_des = None
    ECB = 0
    CBC = 1
