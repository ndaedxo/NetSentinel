#!/usr/bin/env python3
"""
Validation utilities for NetSentinel
"""
...
def validate_alert_data(alert_data: Dict[str, Any]) -> ValidationResult:
    ...
    required_fields = ["id", "title", "description", "severity", "source", "timestamp"]
    for field in required_fields:
